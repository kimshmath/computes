...
// 		
// 	This program checks the polygonality of a given word in F_2=<a,b>.
//
// 	GNU LP solver library is needed.
// 	HOW to install GNU LP Solver Kit:
// 1. Download GNU LP Solver Kit to $HOME/glpk
...
rm *.so
*/
// HOW to compile polygword.cc:
/*
g++ -I$HOME/glpk/include -c polygword.cc
g++ -L$HOME/glpk/lib polygword.o -lglpk -lm
*/
// OR, use the following to use Intel C++ Compiler:
/*
icc -Kc++ -I$HOME/glpk/include -c polygword.cc
icc -Kc++ -L$HOME/glpk/lib -o polygword.out polygword.o -lglpk -lm 
*/
// HOW to execute polygword.out:
/*
./polygword.out < w
where w is a word (e.g. aBaBAbb)
OR,
./polygword.out < input.txt > output.txt
where input.txt contains the word
*/
